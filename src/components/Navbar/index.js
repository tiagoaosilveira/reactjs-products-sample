...
function Navbar(props) {
  ...
  let tabs = [
    { name : 'Products', icon : 'fas fa-layer-group', href : '/products'}
  ];
            ...
            <ul>
                {tabs.map( tab => {
                  return (
                    <li 
                      key={tab.name}
                      className={tab.href === active ? 'is-active' : ''} 
                      onClick={() => changeTab(tab)}>
                      <a>
                        <span className="icon is-small"><i className={tab.icon}></i></span>
                        <span>{tab.name}</span>
                      </a>
                    </li> 
                  )
